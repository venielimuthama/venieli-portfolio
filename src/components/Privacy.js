...
export default function Privacy() {
  return (
    ...
    <div className="myprivacy">
      <h1 className="myh2-privacy">
        <h2>
          {/* style="text-align: center;"> */}
          <b style={{ color: "yellow" }}>PRIVACY POLICY</b>
        </h2>
        <p>Effective date: 2022-03-19</p>
        <p>
          1. <b style={{ color: "yellow" }}>Introduction</b>
        </p>
        <p>
          Welcome to <b>this site</b>.
        </p>
        <p>
          <b>I</b> operate <b>venieli.com</b> (hereinafter referred to as a{" "}
          <b>“Front-End Development Service”</b>).
        </p>
        <p>
          Our Privacy Policy governs your visit to <b>venieli.com</b>, and
        ...
        <p>
          Our Terms and Conditions govern all use of our Service and together
          with the Privacy Policy constitutes your agreement with us .
        </p>
        <p>
          2. <b style={{ color: "yellow" }}>Definitions</b>
        </p>
        <p>
          <b>SERVICE</b> means the venieli.com website operated by Shadrack
          Venieli.
        </p>
        <p>
        ...
        <p>
          3. <b style={{ color: "yellow" }}>Information Collection and Use</b>
        </p>
        <p>
        ...
        <p>
          4. <b style={{ color: "yellow" }}>Types of Data Collected</b>
        </p>
        <p>
          <b>Personal Data</b>
        </p>
        ...
        <p style={{ color: "yellow" }}>0.1. Email address</p>
        <p style={{ color: "yellow" }}>0.2. First name and last name</p>
        <p style={{ color: "yellow" }}>0.3. Phone number</p>
        <p style={{ color: "yellow" }}>
          0.4. Address, Country, State, Province, ZIP/Postal code, City
        </p>
        <p style={{ color: "yellow" }}>0.5. Cookies and Usage Data</p>
        <p>
        ...
        <p>
          0.1. <b style={{ color: "yellow" }}>Session Cookies:</b> We use
          Session Cookies to operate our Service.
        </p>
        <p>
          0.2. <b style={{ color: "yellow" }}>Preference Cookies:</b> We use
          Preference Cookies to remember your preferences and various settings.
        </p>
        <p>
          0.3. <b style={{ color: "yellow" }}>Security Cookies:</b> We use
          Security Cookies for security purposes.
        </p>
        <p>
          0.4. <b style={{ color: "yellow" }}> Advertising Cookies:</b>{" "}
        ...
        <p>
          5. <b style={{ color: "yellow" }}>Use of Data</b>
        </p>
        <p>Shadrack Venieli uses the collected data for various purposes:</p>
        ...
        <p>
          6. <b style={{ color: "yellow" }}>Retention of Data</b>
        </p>
        <p>
        ...
        <p>
          7. <b style={{ color: "yellow" }}>Transfer of Data</b>
        </p>
        <p>
        ...
        <p>
          Shadrack Venieli will take all the steps reasonably necessary to
        ...
        <p>
          8. <b style={{ color: "yellow" }}>Disclosure of Data</b>
        </p>
        <p>
        ...
        <p>
          9. <b style={{ color: "yellow" }}>Security of Data</b>
        </p>
        <p>
        ...
        <p>
          ...
          <b>shadrackmuthama19@gmaail.com</b>.
        </p>
        <p>
        ...
        <p>
          ...
          us at <b style={{ color: "yellow" }}>shadrackmuthama19@gmaail.com</b>.
        </p>
        ...
        <p>
          13. <b style={{ color: "yellow" }}>Service Providers</b>
        </p>
        <p>
        ...
        <p>
          14. <b style={{ color: "yellow" }}>Analytics</b>
        </p>
        <p>
        ...
        <p>
          15. <b style={{ color: "yellow" }}>CI/CD tools</b>
        </p>
        <p>
        ...
        <p>
          16. <b style={{ color: "yellow" }}>Behavioral Remarketing</b>
        </p>
        <p>
        ...
        <p>
          17. <b style={{ color: "yellow" }}>Payments</b>
        </p>
        <p>
        ...
        <p>
          18. <b style={{ color: "yellow" }}>Links to Other Sites</b>
        </p>
        <p>
        ...
        <p>
          19.{" "}
          <b>
            <b style={{ color: "yellow" }}>Children’s Privacy</b>
          </b>
        </p>
        <p>
        ...
        <p>
          20. <b style={{ color: "yellow" }}>Changes to This Privacy Policy</b>
        </p>
        <p>
        ...
        <p>
          21. <b style={{ color: "yellow" }}>Contact Us</b>
        </p>
        <p>
          If you have any questions about this Privacy Policy, please contact us
          by email:{" "}
          <b style={{ color: "yellow" }}>shadrackmuthama19@gmail.com</b>.
        </p>
        <p>{/* style="margin-top: 5em; font-size: 0.7em;"> */}</p>
      </h1>
      </div>
      </Transitions>
  );
